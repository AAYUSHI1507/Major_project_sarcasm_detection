...
df_1 = pd.read_csv('C:/Users/Hp/Documents/vscode_folder/major_project_part2sarc/dataset_f/bbc_news.csv')
df_1.drop(['pubDate','guid','link','description'],inplace=True,axis=1)
...
dataframe_1.to_pickle('saved_dataframe2.pkl')